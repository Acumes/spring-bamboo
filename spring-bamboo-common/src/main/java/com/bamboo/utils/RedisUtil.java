...
public class RedisUtil {
    ...
    public boolean lock(String lockKey,String timeStamp){
        ...
        if(!CommonUtil.isEmpty(currentLock) && Long.parseLong(currentLock) < System.currentTimeMillis()){
            ...
            if(!CommonUtil.isEmpty(preLock) && preLock.equals(currentLock)){
                return true;
            }
        }
    ...
    public void release(String lockKey,String timeStamp){
        try {
            ...
            if(!CommonUtil.isEmpty(currentValue) && currentValue.equals(timeStamp) ){
                // 删除锁状态
